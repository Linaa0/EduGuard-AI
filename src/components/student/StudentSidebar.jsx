  ...
  return (
    <aside className="w-64 bg-navy-900 border-r border-navy-800 flex flex-col justify-between shrink-0 min-h-[calc(100vh-4rem)] text-slate-300">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="p-3.5 rounded-xl bg-navy-800/80 border border-navy-700/60 flex items-center gap-3">
      ...
      <div className="p-4 border-t border-navy-800/80 bg-navy-950/40">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-navy-800 hover:bg-navy-700 text-slate-300 hover:text-white text-xs border border-navy-700 transition-colors"
        >
