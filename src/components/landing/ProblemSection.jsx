  ...
  return (
    <section className="py-20 bg-slate-900 border-t border-slate-800 text-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 p-6 sm:p-8 rounded-2xl bg-slate-950 border border-rose-500/20 shadow-xl">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-5 gap-4 relative">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 text-center space-y-2">
              <div className="w-8 h-8 rounded-lg bg-slate-800 text-slate-300 mx-auto flex items-center justify-center font-bold text-xs">1</div>
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 text-center space-y-2">
              <div className="w-8 h-8 rounded-lg bg-slate-800 text-slate-300 mx-auto flex items-center justify-center font-bold text-xs">3</div>
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 text-center space-y-2">
              <div className="w-8 h-8 rounded-lg bg-slate-800 text-slate-300 mx-auto flex items-center justify-center font-bold text-xs">5</div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-slate-800/80">
            
            <div className="flex items-start gap-3.5 p-4 rounded-xl bg-slate-900/60 border border-slate-800">
