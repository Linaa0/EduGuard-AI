  ...
  return (
    <div className="p-6 sm:p-8 space-y-8 bg-cream dark:bg-slate-900 min-h-full">
      ...
      <div className="pb-4 border-b border-divider dark:border-slate-700">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-charcoal dark:text-white tracking-tight">Platform & AI Settings</h1>
        <p className="text-xs sm:text-sm text-slategray dark:text-slate-400 mt-1">Configure AI sensitivity, RAG retrieval thresholds, and grading scales</p>
      </div>
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-divider dark:border-slate-700 shadow-subtle space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            <div className="space-y-1">
              <label className="font-bold text-charcoal dark:text-slate-200">Minimum Confidence Threshold for Auto-Suggestion</label>
              <select defaultValue="80" className="w-full p-2.5 rounded-xl border border-slate-300 bg-cream-50 dark:bg-slate-700">
            ...
            <div className="space-y-1">
              <label className="font-bold text-charcoal dark:text-slate-200">Primary Foundation Model</label>
              <select defaultValue="ejochat" className="w-full p-2.5 rounded-xl border border-slate-300 bg-cream-50 dark:bg-slate-700">
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-divider dark:border-slate-700 shadow-subtle space-y-4">
          ...
          <div className="space-y-3 text-xs">
            <label className="flex items-center gap-3">
              ...
              <span className="font-semibold text-charcoal dark:text-slate-200">Enforce Mandatory Lecturer Sign-Off before student grade publication (Non-negotiable)</span>
            </label>
            <label className="flex items-center gap-3">
              <input type="checkbox" defaultChecked className="rounded text-blue-600 focus:ring-blue-500 w-4 h-4" />
              <span className="text-charcoal dark:text-slate-200">Attach criterion-level reasoning and learning resources to every student notification</span>
            </label>
          </div>
        </div>
