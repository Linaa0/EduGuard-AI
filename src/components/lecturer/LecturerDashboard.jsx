  ...
  return (
    <div className="p-6 sm:p-8 space-y-8 bg-cream dark:bg-slate-900 min-h-full">
      ...
      <div className="rounded-2xl bg-white dark:bg-slate-800 border border-divider dark:border-slate-700 shadow-card overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-2 rounded-xl border border-slate-200 dark:border-slate-600 text-xs bg-slate-50 dark:bg-slate-700 text-charcoal dark:text-slate-200 placeholder:text-slategray dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-transparent transition-all"
              />
            </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-cream-100 dark:divide-slate-700">
              {filteredAssessments.map((item) => (
                <tr 
                  key={item.id} 
                  className={`hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors ${item.id === 'sub-01' ? 'bg-blue-50/30 dark:bg-slate-700/20' : ''}`}
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-lg bg-slate-800 dark:bg-slate-700 text-white font-bold flex items-center justify-center text-xs">
                  ...
                  <td className="px-6 py-4 font-mono font-bold text-charcoal dark:text-white">
                    {item.score}
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <button
                      onClick={() => setLecturerTab('human-review')}
                      className="px-3.5 py-2 rounded-lg bg-slate-100 dark:bg-slate-700 hover:bg-primary hover:text-white text-charcoal dark:text-slate-200 font-semibold text-xs border border-slate-200 dark:border-slate-600 transition-colors flex items-center gap-1.5"
                    >
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-700/30 border-t border-slate-200 dark:border-slate-700 text-xs text-slategray dark:text-slate-400 flex items-center justify-between">
