  ...
  return (
    <div className="p-6 sm:p-8 space-y-8 bg-cream dark:bg-slate-900 min-h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-divider dark:border-slate-700">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-charcoal dark:text-white tracking-tight">Pedagogical Feedback Moderation</h1>
      ...
      <div className="rounded-2xl bg-white dark:bg-slate-800 border border-divider dark:border-slate-700 shadow-subtle p-6 space-y-6">
        <div className="flex items-center justify-between pb-3 border-b border-divider dark:border-slate-700">
          <div>
            ...
            <h3 className="text-base font-bold text-charcoal dark:text-white">Jean Claude — Climate Change Essay (ENV-101)</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 rounded-xl bg-cream-50 dark:bg-slate-700 border border-divider dark:border-slate-700 space-y-2">
            <span className="text-xs font-bold text-charcoal dark:text-white flex items-center gap-1.5">
