...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-navy-900 border-r border-navy-800 flex flex-col justify-between shrink-0 min-h-[calc(100vh-4rem)] text-slate-300">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="p-3 rounded-xl bg-navy-800/60 border border-navy-700/60">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold tracking-wider text-brand-400">Current Course</span>
            ...
            return (
              ...
              >
                ...
                {item.badge && !item.alertBadge && (
                  <span className="px-1.5 py-0.5 text-[10px] font-medium rounded bg-navy-800 text-slate-400 border border-navy-700">
                    {item.badge}
                  </span>
                )}
              </button>
      ...
      <div className="p-4 space-y-3 border-t border-navy-800/80 bg-navy-950/40">
        
        <div className="p-2.5 rounded-lg bg-gradient-to-r from-brand-950/40 to-navy-900 border border-brand-500/30">
        ...
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-navy-800/70 hover:bg-navy-800 text-slate-300 hover:text-white text-xs border border-navy-700/50 transition-colors"
        >
